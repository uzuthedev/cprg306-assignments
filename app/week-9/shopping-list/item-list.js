...
export default function ItemsList({itemsArray, onItemSelect}){
  ...
  return(
    <section>
    <div className="flex flex-col max-h-f m-auto w-1/2 bg-green-800 p-5 items-center rounded-3xl border-double border-x-2 border-b-8 border-grey-500 shadow-2xl shadow-grey-950">
