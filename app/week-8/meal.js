...
export default function Meal({ingredient, meal, handleMealSelect}) {
   ...
   return (
       <section className="flex-1 text-center mt-10 border-solid border-2 border-grey-500 rounded-lg bg-black-700">
           <div className="flex flex-col m-auto w-1/2 bg-black-800 p-5 items-center rounded-3xl border-b-8 border-grey-500 shadow-2xl shadow-black-950 my-5">
           ...
           <div>
               {ingredients != null && <div className="flex flex-col m-auto w-1/2 bg-black-800 p-5 items-center rounded-3xl border-b-8 border-grey-500 shadow-2xl shadow-emerald-950 my-5">
