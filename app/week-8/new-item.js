...
export default function NewItem({onAddItem}){
    ...
    let buttonEnable = "transition ease-in-out delay-150 hover:scale-110 duration-300 bg-blue-700 hover:bg-blue-800 active:bg-blue-950 rounded text-white h-10 w-10 text-lg text-center";
    let fieldContainer = "flex flex-col bg-grey-400 p-5 text-center rounded-lg shadow-inner shadow-grey-900";
    let container = "flex flex-col m-auto w-1/2 bg-blue-800 p-5 items-center rounded-3xl border-double border-x-2 border-b-8 border-grey-500 shadow-2xl shadow-emerald-950";
        ...
        <section>
            <form onSubmit={handleSubmit}>
                ...
                <p className="text-4xl text-center font-light text-slate-100 font-mono mt-10">How Many?</p>
                    ...
                    <button type="submit" className="transition ease-in-out delay-150 hover:scale-110 duration-300 bg-black-700 hover:bg-emerald-950 active:bg-black-950 rounded text-4xl text-center font-light text-slate-100 font-mono mt-10 p-3" >Add Item</button>
                </div>
            </form>
        </section>
